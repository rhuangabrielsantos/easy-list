...
export default function Main() {
  ...
  return (
    <main className="flex flex-col items-center justify-start mt-5 w-screen">
      ...
      <div className="flex flex-col items-center justify-start mt-5 h-96 max-h-96 w-4/12 overflow-y-auto">
        {todo.map((note, index) => (
          <motion.div 
            ...
            whileTap={{ scale: 0.95 }}
          >
            <div className="w-1/12" onClick={() => checkNote(index)}>
            ...
            <div className="w-1/12" onClick={() => trashNote(index)}>
